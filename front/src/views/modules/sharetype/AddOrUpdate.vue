  ...
  <div class="form-container front-add-page">
    <el-card shadow="hover" class="form-card">
      ...
      <el-form
        ...
        class="form-main"
      >
    <el-form-item label="分类名称" prop="sharetypename">
      <el-input
        v-model="form.sharetypename"
        :placeholder="'请输入分类名称'"
        :readonly="read.sharetypename"
        clearable
      />
    </el-form-item>
...
async function loadDetail(id: number) {
  try {
    resetReadState()
    const res: any = await http.get('sharetype/detail/' + id)
...
async function handleSubmit() {
  ...
  try {
    ...
    const api = isEdit.value && !isCross.value ? 'sharetype/update' : 'sharetype/add'
    const payload = { ...form }
