  ...
  <div class="form-container front-add-page">
    <el-card shadow="hover" class="form-card">
      ...
      <el-form
        ...
        class="form-main"
      >
    <el-form-item label="账号" prop="coachaccount">
      <el-input
    ...
    <el-form-item label="教练头像" prop="coachimage">
      <UploadField
        v-model="form.coachimage"
        upload-type="image"
        :readonly="read.coachimage"
      />
    </el-form-item>
    ...
    <el-form-item label="擅长领域" prop="specialty">
      <el-input
        ...
        :placeholder="'请输入擅长领域'"
        :readonly="read.specialty"
        clearable
      />
    </el-form-item>
    <el-form-item label="教练等级" prop="coachlevel">
      <el-select v-model="form.coachlevel" placeholder="请选择教练等级" clearable :disabled="read.coachlevel">
        <el-option
          v-for="opt in dictOptions.coachlevel"
          :key="opt"
          :label="opt"
          :value="opt"
        />
    ...
    <el-form-item label="从业年限" prop="workyears">
      <el-input-number v-model="form.workyears" placeholder="请输入从业年限" :step="1" :controls="false" :disabled="read.workyears" />
    </el-form-item>
...
const rules = reactive<FormRules>({
    ...
    'coachname': [
      { required: false, message: '请输入教练姓名', trigger: 'blur' }
    ],
    'coachimage': [
      { required: false, message: '请输入教练头像', trigger: 'blur' }
    ],
    'sex': [
    ...
    'specialty': [
      { required: false, message: '请输入擅长领域', trigger: 'blur' }
    ],
    'coachlevel': [
      { required: false, message: '请输入教练等级', trigger: 'blur' }
    ],
    'workyears': [
      { required: false, message: '请输入从业年限', trigger: 'blur' }
    ],
    'addtime': [
...
async function handleSubmit() {
  ...
  try {
    ...
    const api = isEdit.value && !isCross.value ? 'coach/update' : 'coach/add'
    const payload = { ...form }
