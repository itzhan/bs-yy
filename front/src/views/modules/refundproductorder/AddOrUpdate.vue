...
async function loadDetail(id: number) {
  try {
    resetReadState()
    const res: any = await http.get('refundproductorder/detail/' + id)
...
async function handleSubmit() {
  ...
  try {
    ...
    const api = isEdit.value && !isCross.value ? 'refundproductorder/update' : 'refundproductorder/add'
    const payload = { ...form }
