        ...
        <div class="detail-content">
          ...
          <div class="infos">
            <div class="info-item">
              ...
              <span class="text">{{ info.feedbacktitle }}</span>
            </div>
            <div class="info-item">
              <span class="label">内容：</span>
              <span class="text">{{ info.feedbackcontent }}</span>
            </div>
            <div class="info-item">
              <span class="label">反馈类型：</span>
              <span class="text">{{ info.feedbacktype }}</span>
            </div>
          </div>
...
const tableButtonsPermission = useTableButtons('feedback')
...
async function submitAudit() {
  ...
  try {
    ...
    const url = 'feedback/audit/batch?auditstatus=' + status + '&auditreply=' + reply
