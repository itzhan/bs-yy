<template>
  <div class="form-container front-add-page">
    ...
    <el-form-item label="套餐类型" prop="packagetype">
      <el-select v-model="form.packagetype" placeholder="请选择套餐类型" clearable :disabled="read.packagetype">
        <el-option
          v-for="opt in dictOptions.packagetype"
          :key="opt"
          :label="opt"
          :value="opt"
        />
...
const rules = reactive<FormRules>({
    ...
    'packagedesc': [
      { required: false, message: '请输入套餐说明', trigger: 'blur' }
    ],
    'addtime': [
...
async function handleSubmit() {
  ...
  try {
    ...
    const api = isEdit.value && !isCross.value ? 'membershippackage/update' : 'membershippackage/add'
    const payload = { ...form }
