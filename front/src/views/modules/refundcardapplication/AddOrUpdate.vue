...
async function loadDetail(id: number) {
  try {
    resetReadState()
    const res: any = await http.get('refundcardapplication/detail/' + id)
...
async function handleSubmit() {
  ...
  try {
    ...
    const api = isEdit.value && !isCross.value ? 'refundcardapplication/update' : 'refundcardapplication/add'
    const payload = { ...form }
