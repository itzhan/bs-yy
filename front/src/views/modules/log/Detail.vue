        ...
        <div class="detail-content">
          ...
          <div class="infos">
            ...
            <div class="info-item">
              ...
              <span class="text">{{ info.operatetype }}</span>
            </div>
            <div class="info-item">
              <span class="label">业务ID：</span>
              <span class="text">{{ info.businessid }}</span>
            </div>
            <div class="info-item">
              <span class="label">操作人ID：</span>
              <span class="text">{{ info.operatorid }}</span>
            </div>
            <div class="info-item">
              <span class="label">操作人名称：</span>
              <span class="text">{{ info.operatorname }}</span>
            </div>
            <div class="info-item">
              <span class="label">请求路径：</span>
              <span class="text">{{ info.requesturl }}</span>
            </div>
            <div class="info-item">
              <span class="label">请求方法：</span>
              <span class="text">{{ info.requestmethod }}</span>
            </div>
            <div class="info-item">
              <span class="label">请求IP：</span>
              <span class="text">{{ info.requestip }}</span>
            </div>
            <div class="info-item">
...
const tableButtonsPermission = useTableButtons('log')
