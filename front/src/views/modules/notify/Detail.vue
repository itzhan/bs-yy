        ...
        <div class="detail-content">
          ...
          <div class="infos">
            ...
            <div class="info-item">
              ...
              <span class="text">{{ info.messagetype }}</span>
            </div>
            <div class="info-item">
              <span class="label">阅读状态：</span>
              <span class="text">{{ info.readstatus }}</span>
            </div>
            <div class="info-item">
              <span class="label">发送人：</span>
              <span class="text">{{ info.senduser }}</span>
            </div>
          </div>
...
const tableButtonsPermission = useTableButtons('notify')
