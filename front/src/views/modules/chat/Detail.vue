        ...
        <div class="detail-content">
          ...
          <div class="infos">
            <div class="info-item">
              ...
              <span class="text">{{ info.adminid }}</span>
            </div>
            <div class="info-item">
              <span class="label">提问：</span>
              <span class="text">{{ info.ask }}</span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
              <span class="label">提问类型(1文本/2图片)：</span>
              <span class="text">{{ info.asktype }}</span>
            </div>
            <div class="info-item">
              <span class="label">回复类型(1文本/2图片)：</span>
              <span class="text">{{ info.replytype }}</span>
            </div>
            <div class="info-item">
              <span class="label">是否回复(0/1)：</span>
              <span class="text">{{ info.isreply }}</span>
            </div>
            <div class="info-item">
              <span class="label">是否已读(0/1)：</span>
              <span class="text">{{ info.isread }}</span>
            </div>
            <div class="info-item">
              <span class="label">用户名：</span>
              <span class="text">{{ info.uname }}</span>
            </div>
          </div>
...
const tableButtonsPermission = useTableButtons('chat')
