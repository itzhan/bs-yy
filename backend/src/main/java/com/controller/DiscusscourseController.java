...
public class DiscusscourseController {
    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, DiscusscourseEntity discusscourse,
        ...
        QueryWrapper<DiscusscourseEntity> ew = new QueryWrapper<DiscusscourseEntity>();
    ...
    */
    ...
    public R query(DiscusscourseEntity discusscourse){
        ...
        return R.ok("查询健身课程评论表成功").put("data", discusscourseView);
    }
    ...
    */
    ...
    public R info(@PathVariable("id") Long id){
        DiscusscourseEntity discusscourse = discusscourseService.getById(id);
        Map<String, String> deSens = new HashMap<>();
        DeSensUtil.desensitize(discusscourse,deSens);
    ...
    */
    ...
    public R save(@RequestBody DiscusscourseEntity discusscourse, HttpServletRequest request){
        ...
        discusscourse.setId(null);
        if (discusscourse!= null && discusscourse.getUserid() == null) {
            discusscourse.setUserid((Long)request.getSession().getAttribute("userId"));
        }
        discusscourseService.save(discusscourse);
        operationLogRecorder.record("discusscourse", "健身课程评论表", "新增", discusscourse, request);
        return R.ok().put("data",discusscourse.getId());
    }
    ...
    */
    ...
    public R update(@RequestBody DiscusscourseEntity discusscourse, HttpServletRequest request){
        //ValidatorUtils.validateEntity(discusscourse);
        //全部更新
        discusscourseService.updateById(discusscourse);
        operationLogRecorder.record("discusscourse", "健身课程评论表", "修改", discusscourse, request);
        return R.ok();
    }
    ...
    */
    ...
    public R delete(@RequestBody Long[] ids, HttpServletRequest request){
        discusscourseService.removeByIds(Arrays.asList(ids));
        operationLogRecorder.record("discusscourse", "健身课程评论表", "删除", Arrays.asList(ids), request);
        return R.ok();
    }
    ...
    */
    ...
    public R autoSort(@RequestParam Map<String, Object> params, DiscusscourseEntity discusscourse, HttpServletRequest request, String pre){
        QueryWrapper<DiscusscourseEntity> ew = new QueryWrapper<DiscusscourseEntity>();
