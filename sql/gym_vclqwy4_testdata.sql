...
INSERT INTO `coursetype` (`id`,`coursetypename`) VALUES
  (1,'增肌'),(2,'减脂'),(3,'体能'),(4,'瑜伽'),(5,'搏击'),(6,'免费团课');
...
INSERT INTO `course` (`id`,`coursename`,`courseimage`,`coursetype`,`classtime`,`duration`,`coachname`,`coachaccount`,`courseprice`,`quota`,`coursedesc`,`auditstatus`,`auditreply`,`favoritenum`,`likenum`,`clicknum`,`discussnum`) VALUES
  ...
  (5,'格斗拳击','/upload/course5.jpg','免费团课','2026-03-09 19:00:00',60,'刘教练','coach005',0,18,'基础拳击动作与体能结合，免费团课','通过','',10,7,38,1);
...
INSERT INTO `chatmessage` (`id`,`uid`,`fid`,`tablename`,`content`,`format`,`isread`) VALUES
  (1,1,100001,'coach','你好教练，今天训练安排是什么？',1,1),
  (2,100001,1,'coach','深蹲和卧推，9点见',1,1),
  (3,2,100001,'coach','教练，我今天膝盖有点不舒服',1,0),
  (4,6,100004,'coach','赵教练，下次瑜伽课什么时候？',1,0);

-- ============================================================
-- 40. 好友关系（4条）
-- ============================================================
INSERT INTO `friend` (`id`,`uid`,`fid`,`name`,`picture`,`role`,`tablename`,`alias`,`type`,`userid`) VALUES
  (1,1,100001,'李教练','/upload/avatar6.jpg','教练','coach','我的力量教练',1,1),
  (2,2,100001,'李教练','/upload/avatar6.jpg','教练','coach','减脂教练',1,2),
  (3,3,100002,'王教练','/upload/avatar7.jpg','教练','coach','恢复教练',1,3),
  (4,6,100004,'赵教练','/upload/avatar9.jpg','教练','coach','瑜伽教练',1,6);
